...
const checks = [
  ...
  ['AI inline triggers exist', editor.includes('text === "/ai" || text === "++"') && editor.includes('setAiPromptAction("ask")')],
  ['AI shortcuts include requested actions', editor.includes('Fix Grammar') && editor.includes('Professional Tone') && editor.includes('Friendly Tone') && editor.includes('Summarize Selection') && editor.includes('Continue writing')],
