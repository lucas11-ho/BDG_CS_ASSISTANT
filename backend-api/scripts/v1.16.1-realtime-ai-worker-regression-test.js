...
test('v1.16.1 worker foundation remains active in the current release', core.includes('1.18.1-ai-knowledge-runtime') && server.includes('1.18.1-ai-knowledge-runtime'));
