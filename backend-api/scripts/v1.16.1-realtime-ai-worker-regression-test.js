...
test('v1.16.1 worker foundation remains active in the current release', core.includes('1.19.1-admin-trust-security') && server.includes('1.19.1-admin-trust-security'));
