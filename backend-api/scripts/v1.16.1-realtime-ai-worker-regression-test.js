...
test('v1.16.1 worker foundation remains active in the current release', core.includes('1.23.0-topics-security-control') && server.includes('1.23.0-topics-security-control'));
