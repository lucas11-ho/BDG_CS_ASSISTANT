...
test('v1.16.1 worker foundation remains active in the current release', core.includes('1.20.2-admin-2fa-permissions') && server.includes('1.20.2-admin-2fa-permissions'));
