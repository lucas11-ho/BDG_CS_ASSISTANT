...
test('v1.16.1 worker foundation remains active in the current release', core.includes('1.24.0-content-taxonomy-stable-faq-slugs') && server.includes('1.24.0-content-taxonomy-stable-faq-slugs'));
