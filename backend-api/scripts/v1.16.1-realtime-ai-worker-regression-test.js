...
test('v1.16.1 worker foundation remains active in the current release', core.includes('1.22.1-stability-performance') && server.includes('1.22.1-stability-performance'));
