...
test('v1.16.1 worker foundation remains active in the current release', core.includes('1.22.0-secure-platform-transfer') && server.includes('1.22.0-secure-platform-transfer'));
