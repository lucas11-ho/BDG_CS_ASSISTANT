...
expect('v1.17.1 features remain active on the current runtime',core.includes('1.20.2-admin-2fa-permissions')&&server.includes('1.20.2-admin-2fa-permissions'));
expect('backend package version is current v1.18.0',backendPackage.version==='1.18.0');
expect('Admin displays current v1.20.2',adminLayout.includes('const ADMIN_VERSION = "v1.20.2"'));
