...
expect('v1.17.1 release marker is active',core.includes('1.19.1-admin-trust-security')&&server.includes('1.19.1-admin-trust-security'));
expect('backend package version is current v1.18.0',backendPackage.version==='1.18.0');
expect('Admin displays current v1.19.1',adminLayout.includes('const ADMIN_VERSION = "v1.19.1"'));
