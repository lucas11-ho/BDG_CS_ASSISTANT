...
expect('v1.17.1 release marker is active',core.includes('1.18.2-ai-knowledge-library')&&server.includes('1.18.2-ai-knowledge-library'));
expect('backend package version is current v1.18.0',backendPackage.version==='1.18.0');
expect('Admin displays current v1.18.2',adminLayout.includes('const ADMIN_VERSION = "v1.18.2"'));
