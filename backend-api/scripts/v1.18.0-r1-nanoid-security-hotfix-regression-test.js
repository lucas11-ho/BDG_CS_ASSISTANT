...
test('Later additive migrations preserve the v1.18.4 migration chain without changing the Nano ID hotfix contract', () => {
  ...
  assert.ok(files.some((x) => x.startsWith('050_v1.18.4_r2_')));
});
