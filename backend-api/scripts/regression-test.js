...
expect("Backend and server report the current security release", core.includes("1.24.0-content-taxonomy-stable-faq-slugs") && server.includes("1.24.0-content-taxonomy-stable-faq-slugs"));
...
expect("Admin release marker is v1.24.0", adminLayout.includes('const ADMIN_VERSION = "v1.24.0"'));
