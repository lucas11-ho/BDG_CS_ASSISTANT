...
expect("Backend and server report the current security release", core.includes("1.23.0-topics-security-control") && server.includes("1.23.0-topics-security-control"));
...
expect("Admin release marker is v1.23.0", adminLayout.includes('const ADMIN_VERSION = "v1.23.0"'));
