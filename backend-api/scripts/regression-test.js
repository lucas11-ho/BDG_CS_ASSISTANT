...
expect("Backend and server report the current security release", core.includes("1.20.2-admin-2fa-permissions") && server.includes("1.20.2-admin-2fa-permissions"));
...
expect("Admin release marker is v1.20.2", adminLayout.includes('const ADMIN_VERSION = "v1.20.2"'));
