...
expect("Backend and server retain the SSE delivery runtime on the current release", core.includes("1.19.1-admin-trust-security") && server.includes("1.19.1-admin-trust-security"));
...
expect("Admin release marker is v1.19.1", adminLayout.includes('const ADMIN_VERSION = "v1.19.1"'));
